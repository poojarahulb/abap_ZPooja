...
@EndUserText.label: 'BOOKING VIEW INTERFACE'
@Metadata.ignorePropagatedAnnotations: true
define view entity ZPI_BOOKING_M
  as select from ZPBOOKING_M as Booking

  association        to parent ZPI_TRAVEL_M      as _Travel        on  $projection.travel_id = _Travel.travel_id
  composition [0..*] of ZPI_BOOKSUPPL_M          as _BookSupplement
